...
env->
ReleaseByteArrayElements(jStreamMap, streamMapBytes,
0);
...
env->
CallObjectMethod(jOutputBuffer, outputBufferInit, jTimeUs, outputSize
);
if (env->
...
return env->
NewStringUTF(opus_strerror(errorCode)
);
}
...
NewStringUTF (opus_get_version_string());
