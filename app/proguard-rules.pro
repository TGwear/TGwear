...
-keep class com.gohj99.tgwear.model.ReleaseInfo { *; }
-keep class com.gohj99.tgwear.model.Asset { *; }
...
# 保留广播接收器整类不混淆
-keep class com.gohj99.tgwear.utils.notification.NotificationDismissReceiver { *; }
-keep class com.gohj99.tgwear.utils.notification.NotificationActionReceiver { *; }
# 保留常量字段不被删除或重命名
-keepclassmembers class com.gohj99.tgwear.** {
